...
public class Addition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plusLevel = storage.getInt("plusLevel", plusLevel);
        //plusLevel = 4;
    ...
    public void goToResults() {
        ...
        if (currentLevel > plusLevel) {
            plusLevel = currentLevel;
            storage.edit().putInt("plusLevel", plusLevel).apply();
        }

        Intent goToResults = new Intent(Addition.this, Results.class);
    ...
    public void generateQuestion() {
        int a, b, range, wRange, firstW, secondW;
        ...
        for (int i=0; i<4; i++) {
            if (i == locationOfCorrectAnswer) {
                ...
                incorrectAnswer = rand.nextInt(firstW + secondW);
